...
import {
  ...
  BullMQModuleOptions,
  BullMQModuleOptionsFactory,
} from '@/bullmq-module.interfaces';
import {
  createBullMQConnection,
  getBullMQOptionsToken,
  getBullMQConnectionToken,
} from '@/bullmq-module.utils';
...
export class BullMQCoreModule {
  ...
  static forRoot(
    ...
    return {
      ...
      providers: [bullMQOptionsProvider, bullMQConnectionProvider],
      exports: [bullMQOptionsProvider, bullMQConnectionProvider],
    };
  }
  ...
  public static createAsyncOptionsProvider(
    ...
    return {
      provide: getBullMQOptionsToken(options, connection),
      async useFactory(
        optionsFactory: BullMQModuleOptionsFactory,
